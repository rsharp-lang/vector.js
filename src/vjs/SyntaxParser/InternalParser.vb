#Region "Microsoft.VisualBasic::95840d2b2593ae5fd31105ad8410db6d, D:/GCModeller/src/R-sharp/studio/Rsharp_IL/nts//SyntaxParser/InternalParser.vb"
    ...
    ' 
    '     Function: GetCommaExpression, GetExpression, GetParameters, GetStackExpression, ParseBinaryTree
    '               ParseClosure, ParseCommaList, ParseFunctionValue, ParseJSONliteral, ParseKeywordExpression
    '               ParseTsScript, ParseTypeScriptLine, ParseValueExpression
    ' 
    ' /********************************************************************************/
...
#End If
    ...
    Private Function ParseValueExpression(tokens As SyntaxToken(), opts As SyntaxBuilderOptions) As SyntaxResult
        ...
        If tokens.Length = 1 AndAlso tokens(Scan0) Like GetType(Expression) Then
